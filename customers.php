...
<div class="container">
        <center><h1>Our Valued Customers</h1>
        <br>
            <div class="row">
                <div class="col">
                    ...
                    <table class="table table-hover table-sm table-striped table-dark table-bordered">
                        <thead>
                            ...
                            <th scope="col" class="text-center py-2" style="color:white;">Acount Opening date</th>
                            </tr>
                        </thead>
                        <tbody>
                <?php 
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center py-2"><?php echo $rows['accodate']?></td>
